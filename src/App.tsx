    ...
    <header className="border-b sticky top-0 z-50 transition-colors
      ...
      <div className="max-w-2xl mx-auto px-4 h-14 flex items-center justify-between">
        <Link to="/" className="flex items-center gap-2.5 group">
          ...
          <span className="font-semibold tracking-tight text-zinc-900 dark:text-white">PSP</span>
      ...
      <footer className="border-t mt-16 transition-colors border-zinc-200/80 dark:border-zinc-800/60">
        <div className="max-w-2xl mx-auto px-4 py-6 flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <span className="text-xs text-zinc-400 dark:text-zinc-600">PSP — {t.header_tagline}</span>
          </div>
